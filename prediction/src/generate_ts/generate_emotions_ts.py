...
if __name__ == '__main__':
	...
	parser.add_argument("--fcp",'-fcp', help = "face classification module, for emotions.")
	parser.add_argument("--show",'-s', help="Showing the video.", action="store_true")

	args = parser.parse_args()

	detection_model_path = args.fcp + "/trained_models/detection_models/haarcascade_frontalface_default.xml"
	emotion_model_path = args.fcp + "/trained_models/fer2013_mini_XCEPTION.119-0.65.hdf5"
